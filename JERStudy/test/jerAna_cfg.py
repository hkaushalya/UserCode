...
process.load("UserCode.JERStudy.JER_2011Aug_QCD_Pt_15to3000_TuneZ2_Flat_7TeV_pythia6_cfi")
...
process.jerana = cms.EDFilter('JERStudy',
							patJetsInputTag   = cms.InputTag("patJetsAK5PF"),
