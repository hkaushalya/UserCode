...
transfer_input_files = $currDir/runMuonEff_condor_cfg.py, $currDir/$inputlist
#$currDir/DataPileupHistogram_RA2Summer12_190456-208686_ABCD.root 
Arguments = runMuonEff_condor_cfg.py $filetail $inputlist \$(Cluster) ${configSpecStr} ${dataset} ${_CONDOR_SCRATCH_DIR}
