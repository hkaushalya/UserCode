 ...
 *
 * This will overlay histograms in different root files and produce
 * and eps file.
 *
...
void plotall( TDirectory *target, const vector<pair<TFile*, float> >& vFileList);
