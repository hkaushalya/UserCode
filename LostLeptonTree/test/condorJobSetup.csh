...
foreach dir ( $dirlist )
	...
	if ( ! -d $dir ) then
		...
		if ( $i == 1 ) then
			...
			./fnalCondorSubmit.csh 8 50 $fileList 1 $rootdir 
			cd $curDir
			...
			./fnalCondorSubmit.csh 2 30 $fileList 2 $rootdir 
			cd $curDir
		else if ( $i == 3 ) then
			...
			./fnalCondorSubmit.csh 26 50 $fileList 1 $rootdir
			cd $curDir
		else if ( $i == 4 ) then
			...
			./fnalCondorSubmit.csh 35 50 $fileList 4 $rootdir
			cd $curDir
		else if ( $i == 5 ) then
