...
factorizationSmearedJets = cms.EDFilter(
							"Factorization_SmearedJets",
                      genJetSrc = cms.InputTag("QCDfromSmearing:smearedJets"),
                    #  outputFile = cms.string("Factorization"),
                      ...
                      ApplyEventWeighing = cms.untracked.int32(0),
							 ...
							 PtBinEdges = cms.vdouble(0, 20, 30, 50, 80, 120, 170, 230, 300, 380, 470, 570, 680, 800, 1000, 1300, 1700, 2200, 2800, 3500),
#	EtaBinEdges = cms.vdouble(0, 0.5, 1.1, 1.7, 2.3, 3.2, 5.0),
							 ...
							 InputHisto1 = cms.string('hResponse1'),
							 InputHisto2 = cms.string('hResponse2'),
							 InputHisto3p = cms.string('hResponse3p'),
...
#	probExtreme = cms.double(3.e-5),
							 ...
							 NJets = cms.int32(3),
							 JetsHTPt = cms.double(50.),
							 JetsHTEta = cms.double(2.5),
