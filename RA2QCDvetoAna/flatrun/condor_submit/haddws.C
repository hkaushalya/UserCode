...
void haddws() {
   ...
   Target = TFile::Open( "qcd_all.root", "RECREATE" );
	...
	vFileList.push_back(make_pair(TFile::Open("QCD_HT300to470.root"),w[0]));
	vFileList.push_back(make_pair(TFile::Open("QCD_HT470to600.root"),w[1]));
	vFileList.push_back(make_pair(TFile::Open("QCD_HT600to800.root"),w[2]));
	vFileList.push_back(make_pair(TFile::Open("QCD_HT800to1000.root"),w[3]));
	vFileList.push_back(make_pair(TFile::Open("QCD_HT1000to1400.root"),w[4]));
	vFileList.push_back(make_pair(TFile::Open("QCD_HT1400to1800.root"),w[5]));
	vFileList.push_back(make_pair(TFile::Open("QCD_HT1800.root"),w[6]));
