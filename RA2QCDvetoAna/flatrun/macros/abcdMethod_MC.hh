...
class abcdMethod_MC
{
	public:
		...
		struct input_t {
			...
			vector< vector<vector< pair<abcdMethod_MC::Predictions_t, abcdMethod_MC::Predictions_t> > > > results;  //gaus/exp 
			//njet/ht/mht/systs
			//vector< vector< vector<vector< abcdMethod_MC::Syst_t > > > > Systs; //holds 6 individual systematics. pred_mean is the only used variable
			//one fit per njet bin
			vector< abcdMethod_MC::Syst_t > Systs; //holds 6 individual systematics. pred_mean is the only used variable
		};
